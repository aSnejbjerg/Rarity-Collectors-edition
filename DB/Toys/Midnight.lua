...
midnightToys["Jaktu's Cursed Blade"] = {
	cat = CONSTANTS.ITEM_CATEGORIES.MIDNIGHT,
	type = CONSTANTS.ITEM_TYPES.ITEM,
	isToy = true,
...
midnightToys["Diver's Key Fragment"] = {
	cat = CONSTANTS.ITEM_CATEGORIES.MIDNIGHT,
	type = CONSTANTS.ITEM_TYPES.ITEM,
	method = CONSTANTS.DETECTION_METHODS.NPC,
...
-- midnightToys["Ancient Amani Mask"] = {
-- 	cat = CONSTANTS.ITEM_CATEGORIES.MIDNIGHT,
-- 	type = CONSTANTS.ITEM_TYPES.ITEM,
-- 	istoy = true,
-- 	method = CONSTANTS.DETECTION_METHODS.USE,
...
-- 	coords = { { m = CONSTANTS.UIMAPIDS.COILED_ISLES } },
-- }
midnightToys["Pearl of Jubilation"] = {
	cat = CONSTANTS.ITEM_CATEGORIES.MIDNIGHT,
	type = CONSTANTS.ITEM_TYPES.ITEM,
	isToy = true,
	method = CONSTANTS.DETECTION_METHODS.USE,
...
midnightToys["Forgotten Memento"] = {
	cat = CONSTANTS.ITEM_CATEGORIES.MIDNIGHT,
	type = CONSTANTS.ITEM_TYPES.ITEM,
	isToy = true,
	method = CONSTANTS.DETECTION_METHODS.USE,
...
midnightToys["Malfunctioning Staff"] = {
	cat = CONSTANTS.ITEM_CATEGORIES.MIDNIGHT,
	type = CONSTANTS.ITEM_TYPES.ITEM,
	isToy = true,
	method = CONSTANTS.DETECTION_METHODS.USE,
...
midnightToys["Idol of Blue Water and Blue Sky"] = {
	cat = CONSTANTS.ITEM_CATEGORIES.MIDNIGHT,
	type = CONSTANTS.ITEM_TYPES.ITEM,
	isToy = true,
	method = CONSTANTS.DETECTION_METHODS.USE,
