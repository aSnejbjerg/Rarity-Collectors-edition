...
L["Multifarm"] = true
L["If you're farming the same items on multiple accounts at once, set this to the number of accounts to add that many attempts per detected event instead of just one. Can also be set via /rarity multifarm <number>. Resets to 1 whenever you log in."] = true
